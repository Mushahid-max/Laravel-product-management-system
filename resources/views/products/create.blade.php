      ...
      <div class="card border-0 shadow-lg my-3">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input value="{{old('name')}}" type="text" class=" @error('name') is-invalid @enderror form-control form-control-lg" placeholder="Enter your name..." name="name">
          </div>
          @error('name')
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" name="description"  value="{{old('description')}}" cols="30" rows="4" placeholder="Enter description..."></textarea>
          </div>
