...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-dark py-3">
        <h3 class="text-white text-center">LARAVEL CRUD APP</h3>
      ...
      <div class="card border-0 shadow-lg my-3">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input value="{{old('name',$product->name)}}" type="text" class=" @error('name') is-invalid @enderror form-control form-control-lg" placeholder="Enter your name..." name="name">
          </div>
          @error('name')
          <p class="invalid_feedback">{{$message}}</p>
          @enderror
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" name="description"  value="{{old('description',$product->description)}}" cols="30" rows="4" placeholder="Enter description..."></textarea>
          </div>
